...
function iobTotal(opts, time) {
    console.error("💧 === IOB TOTAL DEBUG START ===");
    ...
    console.error("💧 Processed treatments:", treatmentCount);
    console.error("💧 === IOB TOTAL RESULT ===");
    console.error("💧 Total IOB:", Math.round(iob * 1000) / 1000);
    console.error("💧 Basal IOB:", Math.round(basaliob * 1000) / 1000);
    console.error("💧 Bolus IOB:", Math.round(bolusiob * 1000) / 1000);
    console.error("💧 Activity:", Math.round(activity * 10000) / 10000);
    console.error("💧 =======================");
