...
//console.error("skipping:",glucose_data[i].glucose,glucose_data[i-1].glucose);
    ...
    // 🔍 DEBUG: Show first 10 sorted deviations for comparison with Swift
    console.error("🔍 First 10 sorted deviations:");
    for (var i = 0; i < Math.min(10, deviations.length); i++) {
        console.error("   [" + i + "] = " + deviations[i].toFixed(2));
    }
    ...
    // 🔍 DEBUG: Key percentile values
    console.error("🔍 pSensitive (50th percentile): " + pSensitive.toFixed(2));
    console.error("🔍 Total deviations analyzed: " + deviations.length);
    ...
    if(pSensitive < 0) { // sensitive
        ...
        console.error("🔍 basalOff = " + pSensitive.toFixed(4) + " * 12.0 / " + profile.sens + " = " + basalOff.toFixed(4));
    } else if (pResistant > 0) { // resistant
        basalOff = pResistant * (60/5) / profile.sens;
        process.stderr.write("Insulin resistance detected: ");
        console.error("🔍 basalOff = " + pResistant.toFixed(4) + " * 12.0 / " + profile.sens + " = " + basalOff.toFixed(4));
    } else {
    ...
    console.error("🔍 maxDailyBasal = " + profile.max_daily_basal.toFixed(2));
    console.error("🔍 ratio = 1.0 + (" + basalOff.toFixed(4) + " / " + profile.max_daily_basal.toFixed(2) + ") = " + ratio.toFixed(4));
    ...
    console.error("📊 JS AUTOSENS RESULT: ratio=" + ratio.toFixed(2) + ", deviation=" + pSensitive.toFixed(1) + ", deviations=" + deviations.length);
