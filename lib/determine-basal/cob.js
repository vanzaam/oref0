...
function detectCarbAbsorption(inputs) {
    console.error("🍬 === COB DETECTION START ===");
    ...
    console.error("🍬 Glucose data points:", glucose_data.length);
    console.error("🍬 Meal time:", mealTime);
    console.error("🍬 CI time:", ciTime ? ciTime : "undefined");
...
//console.error(glucose_data[i].glucose, bgTime, Math.round(hoursAfterMeal*100)/100, bucketed_data[bucketed_data.length-1].display_time);
    ...
    console.error("🍬 === COB DETECTION RESULT ===");
    console.error("🍬 CarbsAbsorbed:", carbsAbsorbed.toFixed(1));
    console.error("🍬 currentDeviation:", currentDeviation ? currentDeviation.toFixed(2) : null);
    console.error("🍬 maxDeviation:", maxDeviation ? maxDeviation.toFixed(2) : null);
    console.error("🍬 minDeviation:", minDeviation ? minDeviation.toFixed(2) : null);
    console.error("🍬 =============================");
