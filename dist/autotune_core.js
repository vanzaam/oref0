...
function tuneAllTheThings (inputs) {
    console.error("🎯 === AUTOTUNE DEBUG START ===");
    var previousAutotune = inputs.previousAutotune;
    //console.error(previousAutotune);
    var pumpProfile = inputs.pumpProfile;
    console.error("🎯 Previous ISF:", previousAutotune.sens);
    console.error("🎯 Previous CR:", previousAutotune.carb_ratio);
    console.error("🎯 Previous DIA:", previousAutotune.dia);
    ...
    console.error("🎯 === AUTOTUNE RESULT ===");
    console.error("🎯 p50deviation:",p50deviation,"p50BGI:",p50BGI);
    console.error("🎯 p50ratios:",p50ratios);
    console.error("🎯 Old ISF:",ISF,"-> fullNewISF:",fullNewISF,"-> adjustedISF:",adjustedISF,"-> newISF:",newISF);
    console.error("🎯 DIA:",newDIA,"Peak:",newPeak);
    console.error("🎯 ========================");
    ...
    console.error("🎯 === FINAL AUTOTUNE OUTPUT ===");
    console.error("🎯 ISF:", autotuneOutput.sens);
    console.error("🎯 CR:", autotuneOutput.carb_ratio);
    console.error("🎯 CSF:", autotuneOutput.csf);
    console.error("🎯 DIA:", autotuneOutput.dia);
    console.error("🎯 ==============================");
